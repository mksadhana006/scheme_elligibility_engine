...
new_func = """def render_nearest_centers():
    ...
    line1 = ", ".join(parts) if parts else "Location Detected"
    ...
    loc_display = f"{line1}<br>{line2}" if line2 else f"{line1}"
